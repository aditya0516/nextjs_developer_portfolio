...
const Navbar = () => {
  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 sm:p-12 xs:px-8'>
      <button
      ...
      <div className=' w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className=' flex items-center justify-center flex-wrap'>
          ...
          <motion.a
            href='https://www.twitter.com/adityajadhav70/'
            target={"_blank"}
            whileHover={{ y: -3 }}
            whileTap={{ scale: 0.8 }}
            className={"w-8 mx-3"}>
